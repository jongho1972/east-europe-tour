...
| 프로젝트 | 경로 | 배포 URL |
|----------|------|----------|
| 여행 코스 지도 (제목: 동유럽 여행 코스 2026) | `index.html` | https://tour-europe-jhawk.netlify.app |
...
- 도메인 제한: `https://tour-europe-jhawk.netlify.app/*`, `http://localhost/*`
...
- `jh.jpg`: 프로필 사진
- 여행 일정은 `tour-europe-jhawk.netlify.app`을 **iframe으로 임베드** — 직접 코드 없음
